    ...
    public class TestController : ApiController
    {
        ...
        public string InitialSync()
        {
            ...
            try
            {
                ...
                Wrapper.Clothes = new List<SyncClothes>().InjectFrom(dbcontext.Clothes.Where(c => c.IsActive == true && c.IsDelete == false && (dates ? c.DateUpdated < Wrapper.ServerDate : true)));
                    ...
                    if (account != null)
                    {
                        ...
                        if (wrapper.Mode == 0 || wrapper.Mode == 2)
                        {
                            if (wrapper.SubMode == 0 || wrapper.SubMode == 5)
                            {
                                ...
                                Wrapper.Clothes = new List<SyncClothes>().InjectFrom(dbcontext.Clothes.Where(c => c.IsActive == true && c.IsDelete == false && (dates ? c.DateUpdated >= wrapper.SyncDate : true)));
                                var tempClothes = Wrapper.Clothes.Select(r => r.clothesId).ToArray();
