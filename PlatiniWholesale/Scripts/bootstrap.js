    ...
    f.prototype.toggle = function(d) {
        ...
        if (!e.is(".disabled, :disabled")) {
            ...
            if (b(), !g) {
              ...
              //f.toggleClass("newdropdown").trigger("shown.bs.dropdown")
			  if(f.hasClass('newdropdown')){
				    
				    f.removeClass("newdropdown");
					if(f.find('.dropdown-menu').is(':visible')){
						f.find('.dropdown-menu').fadeOut(200 );
					}
			   }else{
				  
				    $(".dropdown").removeClass("newdropdown");
					$(".addactivecls").removeClass('menuactive');
					if(f.find('.dropdown-menu').is(':hidden')){
						$('.dropdown-menu').fadeOut(200 );
						f.addClass("newdropdown");
						f.addClass('menuactive');
						f.find('.dropdown-menu').fadeIn(200 );
					}
