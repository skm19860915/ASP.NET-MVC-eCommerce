...
messages[0] = new Array('', 'This item comes pre-packed. Choose your scale from below.', "#FFFFFF");
messages[1] = new Array('', 'To add a product to your order, please click on “Add To Order”. Then Click on the Arrow that pops up on the left side of the page to view your order.', "#FFFFFF");
